...
> `docs/walkthrough.md` -- report kind 2 (a cross-implementation comparison of one TestCase) -- showing the divergence. The body below (including its own
...
>
> ```bash
> uv run svt view --testcase redefinition-ambiguity-2-resolution
> ```
...
_Scope: testcase `redefinition-ambiguity-2-resolution` only._
...
|---|---|---|---|
| opensysml | `2b6c1cf6c31266396899a90d3290cfbdf44019b9` | inapplicable |  |
...
- **info**: 2 resolution check(s), all_match=True
...
```
UsageTwo::c::@0	Lib::Container::items
