...
EXPECTED_VIOLATIONS = {
    ...
    "testcase_missing_intent": "TestCaseRealizesIntentShape",
    "intent_missing_question": "TestIntentQuestionShape",
    "intent_question_not_interrogative": "TestIntentQuestionShape",
    "intent_bad_concerns": "TestIntentConcernsShape",
    "intent_posterior_state_only_structural_checks": "IntentMethodAlignmentShape",
    "party_missing_label": "PartyLabelShape",
